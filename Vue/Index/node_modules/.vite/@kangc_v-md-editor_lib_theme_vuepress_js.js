  ...
  "node_modules/@kangc/v-md-editor/lib/theme/vuepress.js"(exports, module) {
    !function(e, t) {
      ...
      return function(e) {
        ...
        t.lib = {}, t.lib.mdurl = r(8), t.lib.ucmicro = r(26), t.assign = function(e2) {
          ...
          return e2.indexOf("\\") < 0 && e2.indexOf("&") < 0 ? e2 : e2.replace(c, function(e3, t2, r2) {
            return t2 || function(e4, t3) {
              var r3 = 0;
              return i(u, t3) ? u[t3] : t3.charCodeAt(0) === 35 && l.test(t3) && s(r3 = t3[1].toLowerCase() === "x" ? parseInt(t3.slice(2), 16) : parseInt(t3.slice(1), 10)) ? o(r3) : e4;
            }(e3, r2);
          });
        ...
        function o(e2) {
          var t2 = e2.codeHighlightExtensionMap, r2 = t2 === void 0 ? {} : t2, n2 = e2.hasLang, i2 = n2 === void 0 ? function() {
            return true;
        ...
        function n(e2, t2) {
          ...
          for (r2 = 0; r2 < c; r2++)
            (i = t2[r2]).marker === 126 && i.end !== -1 && (s = t2[i.end], (o = e2.tokens[i.token]).type = "s_open", o.tag = "s", o.nesting = 1, o.markup = "~~", o.content = "", (o = e2.tokens[s.token]).type = "s_close", o.tag = "s", o.nesting = -1, o.markup = "~~", o.content = "", e2.tokens[s.token - 1].type === "text" && e2.tokens[s.token - 1].content === "~" && a.push(s.token - 1));
          for (; a.length; ) {
        ...
        function n(e2, t2) {
          ...
          for (r2 = t2.length - 1; r2 >= 0; r2--)
            (n2 = t2[r2]).marker !== 95 && n2.marker !== 42 || n2.end !== -1 && (i = t2[n2.end], a = r2 > 0 && t2[r2 - 1].end === n2.end + 1 && t2[r2 - 1].marker === n2.marker && t2[r2 - 1].token === n2.token - 1 && t2[n2.end + 1].token === i.token + 1, o = String.fromCharCode(n2.marker), (s = e2.tokens[n2.token]).type = a ? "strong_open" : "em_open", s.tag = a ? "strong" : "em", s.nesting = 1, s.markup = a ? o + o : o, s.content = "", (s = e2.tokens[i.token]).type = a ? "strong_close" : "em_close", s.tag = a ? "strong" : "em", s.nesting = -1, s.markup = a ? o + o : o, s.content = "", a && (e2.tokens[t2[r2 - 1].token].content = "", e2.tokens[t2[n2.end + 1].token].content = "", r2--));
        }
        e.exports.tokenize = function(e2, t2) {
          ...
          if (s !== 95 && s !== 42)
            return false;
          for (n2 = e2.scanDelims(e2.pos, s === 42), r2 = 0; r2 < n2.length; r2++)
        ...
        function s(e2, t2, r2) {
          let n2 = { match: false, j: null }, i2 = r2.shift !== void 0 ? t2 + r2.shift : r2.position, l = (u = e2, (p = i2) >= 0 ? u[p] : u[u.length + p]);
          var u, p;
          if (l === void 0)
            return n2;
          for (let e3 in r2)
          ...
          e2.core.ruler.before("linkify", "curly_attributes", function(e3) {
            ...
            for (let e4 = 0; e4 < t3.length; e4++)
              for (let r3 = 0; r3 < o2.length; r3++) {
                ...
                n2.tests.every((r4) => {
                  let n3 = s(t3, e4, r4);
                  return n3.j !== null && (i2 = n3.j), n3.match;
                }) && (n2.transform(t3, e4, i2), n2.name !== "inline attributes" && n2.name !== "inline nesting 0" || r3--);
              }
          });
        };
      }, function(e, t, r) {
        ...
        var n = r(1), i = r(15), s = r.n(i), o = function(e2, t2) {
          var r2 = (t2 === void 0 ? {} : t2).lineMarkup, n2 = r2 === void 0 ? "data-line" : r2, i2 = function(e3, t3, r3, n3, i3) {
          ...
          function o2(e3, t3, r3) {
            for (var n2, s3, a2 = [], c2 = "", l2 = t3.length, u2 = e3; u2 < l2; ) {
              ...
              if (p2.type === "heading_close" && i2.includeLevel.indexOf(f2) != -1 && h2.type === "inline") {
                if (n2) {
                  if (f2 > n2) {
        ...
        function g(e2) {
          var t2 = e2 === void 0 ? {} : e2, r2 = t2.toc, i2 = t2.link, c2 = t2.attrs, h2 = Object(d.b)();
          ...
          } }).use(s.a, Object(n.a)({ leftDelimiter: "{{{", rightDelimiter: "}}}" }, c2, { allowedAttributes: ["width", "height"].concat(c2 == null ? void 0 : c2.allowedAttributes) })).use(a, { getMarks: function(e3, t3, r3) {
        ...
        e.exports = (e2) => {
          ...
          } }, { name: "inline nesting 0", tests: [{ shift: 0, type: "inline", children: [{ shift: -1, type: (e3) => e3 === "image" || e3 === "code_inline" }, { shift: 0, type: "text", content: n.hasDelimiters("start", e2) }] }], transform: (t3, r2, i2) => {
          ...
          } }, { name: "end of block", tests: [{ shift: 0, type: "inline", children: [{ position: -1, content: n.hasDelimiters("end", e2), type: (e3) => e3 !== "code_inline" }] }], transform: (t3, r2, s) => {
        ...
        t.getAttrs = function(e2, t2, r2) {
              ...
              if (t3 !== "#" || s2 !== "")
                if (t3 !== '"' || o2 !== "")
                  if (t3 === '"' && c)
                    ...
                    a2 && t3.search(n2) === -1 || (a2 ? s2 += t3 : o2 += t3);
                  else {
                    if (s2 === "")
                      continue;
          ...
          return function(r2) {
            ...
            switch (e2) {
              case "start":
                s2 = r2.slice(0, t2.leftDelimiter.length), n2 = s2 === t2.leftDelimiter ? 0 : -1, i2 = n2 === -1 ? -1 : r2.indexOf(t2.rightDelimiter, c), o2 = r2.charAt(i2 + t2.rightDelimiter.length), o2 && t2.rightDelimiter.indexOf(o2) !== -1 && (i2 = -1);
                break;
              case "end":
                n2 = r2.lastIndexOf(t2.leftDelimiter), i2 = n2 === -1 ? -1 : r2.indexOf(t2.rightDelimiter, n2 + c), i2 = i2 === r2.length - t2.rightDelimiter.length ? i2 : -1;
                break;
              case "only":
        ...
        function i(e2, t2, r2) {
          var s, o, a, c, l, u = "";
          for (typeof t2 != "string" && (r2 = t2, t2 = i.defaultChars), r2 === void 0 && (r2 = true), l = function(e3) {
            var t3, r3, i2 = n[e3];
            if (i2)
              return i2;
            ...
            if (a = e2.charCodeAt(s), r2 && a === 37 && s + 2 < o && /^[0-9a-f]{2}$/i.test(e2.slice(s + 1, s + 3)))
        ...
        function i(e2, t2) {
          var r2;
          return typeof t2 != "string" && (t2 = i.defaultChars), r2 = function(e3) {
            var t3, r3, i2 = n[e3];
            if (i2)
              return i2;
            for (i2 = n[e3] = [], t3 = 0; t3 < 128; t3++)
            ...
            for (t3 = 0, n2 = e3.length; t3 < n2; t3 += 3)
              (i2 = parseInt(e3.slice(t3 + 1, t3 + 3), 16)) < 128 ? l += r2[i2] : (224 & i2) == 192 && t3 + 3 < n2 && (192 & (s = parseInt(e3.slice(t3 + 4, t3 + 6), 16))) == 128 ? (l += (c = i2 << 6 & 1984 | 63 & s) < 128 ? "\uFFFD\uFFFD" : String.fromCharCode(c), t3 += 3) : (240 & i2) == 224 && t3 + 6 < n2 && (s = parseInt(e3.slice(t3 + 4, t3 + 6), 16), o = parseInt(e3.slice(t3 + 7, t3 + 9), 16), (192 & s) == 128 && (192 & o) == 128) ? (l += (c = i2 << 12 & 61440 | s << 6 & 4032 | 63 & o) < 2048 || c >= 55296 && c <= 57343 ? "\uFFFD\uFFFD\uFFFD" : String.fromCharCode(c), t3 += 6) : (248 & i2) == 240 && t3 + 9 < n2 && (s = parseInt(e3.slice(t3 + 4, t3 + 6), 16), o = parseInt(e3.slice(t3 + 7, t3 + 9), 16), a = parseInt(e3.slice(t3 + 10, t3 + 12), 16), (192 & s) == 128 && (192 & o) == 128 && (192 & a) == 128) ? ((c = i2 << 18 & 1835008 | s << 12 & 258048 | o << 6 & 4032 | 63 & a) < 65536 || c > 1114111 ? l += "\uFFFD\uFFFD\uFFFD\uFFFD" : (c -= 65536, l += String.fromCharCode(55296 + (c >> 10), 56320 + (1023 & c))), t3 += 9) : l += "\uFFFD";
            return l;
          });
        }
        ...
        n.prototype.parse = function(e2, t2) {
          ...
          var T = g.indexOf("#");
          T !== -1 && (this.hash = g.substr(T), g = g.slice(0, T));
          var L = g.indexOf("?");
          return L !== -1 && (this.search = g.substr(L), g = g.slice(0, L)), g && (this.pathname = g), d[s2] && this.hostname && !this.pathname && (this.pathname = ""), this;
        ...
        e.exports = function(e2, t2, r2) {
          ...
          for (e2.pos = t2 + 1, n = 1; e2.pos < c; ) {
            if ((s = e2.src.charCodeAt(e2.pos)) === 93 && --n === 0) {
              i = true;
              break;
            }
            if (o = e2.pos, e2.md.inline.skipToken(e2), s === 91) {
              if (o === e2.pos - 1)
                n++;
              else if (r2)
                return e2.pos = l, -1;
        ...
        e.exports = function(e2, t2, r2) {
          ...
          if (e2.charCodeAt(t2) === 60) {
            for (t2++; t2 < r2; ) {
              if ((i = e2.charCodeAt(t2)) === 10)
                return a;
              if (i === 60)
                return a;
              if (i === 62)
                return a.pos = t2 + 1, a.str = n(e2.slice(o + 1, t2)), a.ok = true, a;
              i === 92 && t2 + 1 < r2 ? t2 += 2 : t2++;
            }
            return a;
          }
          for (s = 0; t2 < r2 && (i = e2.charCodeAt(t2)) !== 32 && !(i < 32 || i === 127); )
            if (i === 92 && t2 + 1 < r2) {
          ...
          return o === t2 || s !== 0 || (a.str = n(e2.slice(o, t2)), a.lines = 0, a.pos = t2, a.ok = true), a;
        };
      }, function(e, t, r) {
        "use strict";
        var n = r(0).unescapeAll;
        e.exports = function(e2, t2, r2) {
          ...
          if (t2 >= r2)
            return c;
          if ((s = e2.charCodeAt(t2)) !== 34 && s !== 39 && s !== 40)
            return c;
          for (t2++, s === 40 && (s = 41); t2 < r2; ) {
            if ((i = e2.charCodeAt(t2)) === s)
              return c.pos = t2 + 1, c.lines = o, c.str = n(e2.slice(a + 1, t2)), c.ok = true, c;
            if (i === 40 && s === 41)
              return c;
            i === 10 ? o++ : i === 92 && t2 + 1 < r2 && (t2++, e2.charCodeAt(t2) === 10 && o++), t2++;
          }
          return c;
        };
      }, function(e, t, r) {
        ...
        o.code_inline = function(e2, t2, r2, n2, i2) {
          ...
          return o2.hidden ? "" : (o2.block && o2.nesting !== -1 && t2 && e2[t2 - 1].hidden && (i2 += "\n"), i2 += (o2.nesting === -1 ? "</" : "<") + o2.tag, i2 += this.renderAttrs(o2), o2.nesting === 0 && r2.xhtmlOut && (i2 += " /"), o2.block && (s2 = true, o2.nesting === 1 && t2 + 1 < e2.length && ((n2 = e2[t2 + 1]).type === "inline" || n2.hidden || n2.nesting === -1 && n2.tag === o2.tag) && (s2 = false)), i2 += s2 ? ">\n" : ">");
        }, a.prototype.renderInline = function(e2, t2, r2) {
          for (var n2, i2 = "", s2 = this.rules, o2 = 0, a2 = e2.length; o2 < a2; o2++)
            s2[n2 = e2[o2].type] !== void 0 ? i2 += s2[n2](e2, o2, t2, r2, this) : i2 += this.renderToken(e2, o2, t2);
          return i2;
        }, a.prototype.renderInlineAsText = function(e2, t2, r2) {
          for (var n2 = "", i2 = 0, s2 = e2.length; i2 < s2; i2++)
            e2[i2].type === "text" ? n2 += e2[i2].content : e2[i2].type === "image" ? n2 += this.renderInlineAsText(e2[i2].children, t2, r2) : e2[i2].type === "softbreak" && (n2 += "\n");
          return n2;
        }, a.prototype.render = function(e2, t2, r2) {
          var n2, i2, s2, o2 = "", a2 = this.rules;
          for (n2 = 0, i2 = e2.length; n2 < i2; n2++)
            (s2 = e2[n2].type) === "inline" ? o2 += this.renderInline(e2[n2].children, t2, r2) : a2[s2] !== void 0 ? o2 += a2[e2[n2].type](e2, n2, t2, r2, this) : o2 += this.renderToken(e2, n2, t2, r2);
          return o2;
        }, e.exports = a;
      }, function(e, t, r) {
        "use strict";
        ...
        e.exports = function(e2) {
          ...
          for (r2 = 0, n = i.length; r2 < n; r2++)
            (t2 = i[r2]).type === "inline" && e2.md.inline.parse(t2.content, e2.md, e2.env, t2.children);
        };
      }, function(e, t, r) {
        "use strict";
              ...
              if (y[r2].type === "inline" && e2.md.linkify.pretest(y[r2].content))
                for (g = 0, t2 = (o = y[r2].children).length - 1; t2 >= 0; t2--)
                  if ((c = o[t2]).type !== "link_close") {
                    if (c.type === "html_inline" && (v = c.content, /^<a[>\s]/i.test(v) && g > 0 && g--, i(c.content) && g++), !(g > 0) && c.type === "text" && e2.md.linkify.test(c.content)) {
        ...
        function c(e2) {
          ...
          for (t2 = e2.length - 1; t2 >= 0; t2--)
            (r2 = e2[t2]).type !== "text" || n2 || (r2.content = r2.content.replace(s, a)), r2.type === "link_open" && r2.info === "auto" && n2--, r2.type === "link_close" && r2.info === "auto" && n2++;
        }
        function l(e2) {
          var t2, r2, i2 = 0;
          for (t2 = e2.length - 1; t2 >= 0; t2--)
            (r2 = e2[t2]).type !== "text" || i2 || n.test(r2.content) && (r2.content = r2.content.replace(/\+-/g, "\xB1").replace(/\.{2,}/g, "\u2026").replace(/([?!])…/g, "$1..").replace(/([?!]){4,}/g, "$1$1$1").replace(/,{2,}/g, ",").replace(/(^|[^-])---(?=[^-]|$)/gm, "$1\u2014").replace(/(^|\s)--(?=\s|$)/gm, "$1\u2013").replace(/(^|[^-\s])--(?=[^-\s]|$)/gm, "$1\u2013")), r2.type === "link_open" && r2.info === "auto" && i2--, r2.type === "link_close" && r2.info === "auto" && i2++;
        }
        e.exports = function(e2) {
          var t2;
          if (e2.md.options.typographer)
            for (t2 = e2.tokens.length - 1; t2 >= 0; t2--)
              e2.tokens[t2].type === "inline" && (i.test(e2.tokens[t2].content) && c(e2.tokens[t2].children), n.test(e2.tokens[t2].content) && l(e2.tokens[t2].children));
        };
      }, function(e, t, r) {
        "use strict";
            ...
            if (D.length = C + 1, o2.type === "text") {
              ...
              e:
                for (; p < h && (a.lastIndex = p, u = a.exec(l2)); ) {
                  ...
                  if (_ = s(g) || i(String.fromCharCode(g)), b = s(m) || i(String.fromCharCode(m)), k = n(g), (v = n(m)) ? y = false : b && (k || _ || (y = false)), k ? x = false : _ && (v || b || (x = false)), m === 34 && u[0] === '"' && g >= 48 && g <= 57 && (x = y = false), y && x && (y = _, x = b), y || x) {
                    if (x) {
        ...
        function s(e2) {
          ...
          for (t2 = e2.charCodeAt(n2); n2 < i2; )
            t2 === 124 && (s2 ? (a += e2.substring(o, n2 - 1), o = n2) : (r2.push(a + e2.substring(o, n2)), a = "", o = n2 + 1)), s2 = t2 === 92, n2++, t2 = e2.charCodeAt(n2);
        ...
        e.exports = function(e2, t2, r2, o) {
          ...
          if ((c = i(e2, t2).trim()).indexOf("|") === -1)
            return false;
          if (e2.sCount[t2] - e2.blkIndent >= 4)
            return false;
          if ((f = s(c)).length && f[0] === "" && f.shift(), f.length && f[f.length - 1] === "" && f.pop(), (d = f.length) === 0 || d !== m.length)
            return false;
          if (o)
            return true;
        ...
        e.exports = function(e2, t2, r2, n) {
          ...
          if (h + 3 > f)
            return false;
          if ((i = e2.src.charCodeAt(h)) !== 126 && i !== 96)
            return false;
          if (c = h, (s = (h = e2.skipChars(h, i)) - c) < 3)
            return false;
          if (u = e2.src.slice(c, h), o = e2.src.slice(h, f), i === 96 && o.indexOf(String.fromCharCode(i)) >= 0)
            return false;
          if (n)
            return true;
        ...
        e.exports = function(e2, t2, r2, i) {
          ...
          if (i)
            return true;
          for (c = f = e2.sCount[t2] + 1, e2.src.charCodeAt(w) === 32 ? (w++, c++, f++, s = false, v = true) : e2.src.charCodeAt(w) === 9 ? (v = true, (e2.bsCount[t2] + f) % 4 == 3 ? (w++, c++, f++, s = false) : s = true) : v = false, d = [e2.bMarks[t2]], e2.bMarks[t2] = w; w < E && (o = e2.src.charCodeAt(w), n(o)); )
            o === 9 ? f += 4 - (f + e2.bsCount[t2] + (s ? 1 : 0)) % 4 : f++, w++;
          for (g = [e2.bsCount[t2]], e2.bsCount[t2] = e2.sCount[t2] + 1 + (v ? 1 : 0), u = w >= E, b = [e2.sCount[t2]], e2.sCount[t2] = f - c, k = [e2.tShift[t2]], e2.tShift[t2] = w - e2.bMarks[t2], x = e2.md.block.ruler.getRules("blockquote"), _ = e2.parentType, e2.parentType = "blockquote", h = t2 + 1; h < r2 && (A = e2.sCount[h] < e2.blkIndent, !((w = e2.bMarks[h] + e2.tShift[h]) >= (E = e2.eMarks[h]))); h++)
            if (e2.src.charCodeAt(w++) !== 62 || A) {
              ...
              for (c = f = e2.sCount[h] + 1, e2.src.charCodeAt(w) === 32 ? (w++, c++, f++, s = false, v = true) : e2.src.charCodeAt(w) === 9 ? (v = true, (e2.bsCount[h] + f) % 4 == 3 ? (w++, c++, f++, s = false) : s = true) : v = false, d.push(e2.bMarks[h]), e2.bMarks[h] = w; w < E && (o = e2.src.charCodeAt(w), n(o)); )
                o === 9 ? f += 4 - (f + e2.bsCount[h] + (s ? 1 : 0)) % 4 : f++, w++;
        ...
        e.exports = function(e2, t2, r2, i) {
          ...
          if (e2.sCount[t2] - e2.blkIndent >= 4)
            return false;
          if ((s = e2.src.charCodeAt(l++)) !== 42 && s !== 45 && s !== 95)
            return false;
          for (o = 1; l < u; ) {
        ...
        function i(e2, t2) {
          var r2, i2, s2, o;
          return i2 = e2.bMarks[t2] + e2.tShift[t2], s2 = e2.eMarks[t2], (r2 = e2.src.charCodeAt(i2++)) !== 42 && r2 !== 45 && r2 !== 43 || i2 < s2 && (o = e2.src.charCodeAt(i2), !n(o)) ? -1 : i2;
        }
        function s(e2, t2) {
        ...
        e.exports = function(e2, t2, r2, n2) {
          ...
          if (e2.listIndent >= 0 && e2.sCount[t2] - e2.listIndent >= 4 && e2.sCount[t2] < e2.blkIndent)
            return false;
          if (n2 && e2.parentType === "paragraph" && e2.sCount[t2] >= e2.blkIndent && (M = true), (q = s(e2, t2)) >= 0) {
            if (h = true, F = e2.bMarks[t2] + e2.tShift[t2], b = Number(e2.src.slice(F, q - 1)), M && b !== 1)
              return false;
          } else {
            if (!((q = i(e2, t2)) >= 0))
              return false;
          ...
          if (_ = e2.src.charCodeAt(q - 1), n2)
            return true;
          for (m = e2.tokens.length, h ? (z = e2.push("ordered_list_open", "ol", 1), b !== 1 && (z.attrs = [["start", b]])) : z = e2.push("bullet_list_open", "ul", 1), z.map = g = [t2, 0], z.markup = String.fromCharCode(_), v = t2, S = false, L = e2.md.block.ruler.getRules("list"), C = e2.parentType, e2.parentType = "list"; v < r2; ) {
          ...
          return (z = h ? e2.push("ordered_list_close", "ol", -1) : e2.push("bullet_list_close", "ul", -1)).markup = String.fromCharCode(_), g[1] = v, e2.line = v, e2.parentType = C, I && function(e3, t3) {
            ...
            for (r3 = t3 + 2, n3 = e3.tokens.length - 2; r3 < n3; r3++)
              e3.tokens[r3].level === i2 && e3.tokens[r3].type === "paragraph_open" && (e3.tokens[r3 + 2].hidden = true, e3.tokens[r3].hidden = true, r3 += 2);
          }(e2, m), true;
        };
      }, function(e, t, r) {
        "use strict";
        ...
        e.exports = function(e2, t2, r2, s) {
          ...
          if (C < A && b.charCodeAt(C) !== 10 && y)
            for (y = "", C = a, x = c; C < A && (o = b.charCodeAt(C), i(o)); )
              C++;
          return !(C < A && b.charCodeAt(C) !== 10) && (!!(f = n(b.slice(1, d))) && (s || (e2.env.references === void 0 && (e2.env.references = {}), e2.env.references[f] === void 0 && (e2.env.references[f] = { title: y, href: u }), e2.parentType = g, e2.line = t2 + x + 1), true));
        };
      }, function(e, t, r) {
        "use strict";
        ...
        e.exports = function(e2, t2, r2, i) {
          ...
          if (e2.sCount[t2] - e2.blkIndent >= 4)
            return false;
          if ((s = e2.src.charCodeAt(l)) !== 35 || l >= u)
            return false;
          for (o = 1, s = e2.src.charCodeAt(++l); s === 35 && l < u && o <= 6; )
        ...
        function s(e2, t2, r2, n2) {
          ...
          for (this.src = e2, this.md = t2, this.env = r2, this.tokens = n2, this.bMarks = [], this.eMarks = [], this.tShift = [], this.sCount = [], this.bsCount = [], this.blkIndent = 0, this.line = 0, this.lineMax = 0, this.tight = false, this.ddIndent = -1, this.listIndent = -1, this.parentType = "root", this.level = 0, this.result = "", h = false, a = c = u = p = 0, l = (o = this.src).length; c < l; c++) {
            ...
            s2 !== 10 && c !== l - 1 || (s2 !== 10 && c++, this.bMarks.push(a), this.eMarks.push(c), this.tShift.push(u), this.sCount.push(p), this.bsCount.push(0), h = false, u = 0, p = 0, a = c + 1);
          }
          ...
          if (r2 = e2.pending.length - 1, i = e2.posMax, !t2)
            if (r2 >= 0 && e2.pending.charCodeAt(r2) === 32)
              if (r2 >= 1 && e2.pending.charCodeAt(r2 - 1) === 32) {
                for (s = r2 - 1; s >= 1 && e2.pending.charCodeAt(s - 1) === 32; )
                  s--;
        ...
        "\\!\"#$%&'()*+,./:;<=>?@[]^_`{|}~-".split("").forEach(function(e2) {
          ...
          if (e2.src.charCodeAt(s2) !== 92)
            return false;
          if (++s2 < o) {
            if ((r2 = e2.src.charCodeAt(s2)) < 256 && i[r2] !== 0)
        ...
        e.exports = function(e2, t2) {
          ...
          if ((l = a + 1) < g && e2.src.charCodeAt(l) === 40) {
            for (_ = false, l++; l < g && (s = e2.src.charCodeAt(l), i(s) || s === 10); l++)
              ;
            if (l >= g)
              return false;
            if (m = l, (u = e2.md.helpers.parseLinkDestination(e2.src, l, e2.posMax)).ok) {
              for (h = e2.md.normalizeLink(u.str), e2.md.validateLink(h) ? l = u.pos : h = "", m = l; l < g && (s = e2.src.charCodeAt(l), i(s) || s === 10); l++)
                ;
              if (u = e2.md.helpers.parseLinkTitle(e2.src, l, e2.posMax), l < g && m !== l && u.ok)
                for (f = u.str, l = u.pos; l < g && (s = e2.src.charCodeAt(l), i(s) || s === 10); l++)
                  ;
            }
        ...
        e.exports = function(e2, t2) {
          ...
          if ((u = c + 1) < k && e2.src.charCodeAt(u) === 40) {
            for (u++; u < k && (s = e2.src.charCodeAt(u), i(s) || s === 10); u++)
              ;
            if (u >= k)
              return false;
            for (m = u, (h = e2.md.helpers.parseLinkDestination(e2.src, u, e2.posMax)).ok && (_ = e2.md.normalizeLink(h.str), e2.md.validateLink(_) ? u = h.pos : _ = ""), m = u; u < k && (s = e2.src.charCodeAt(u), i(s) || s === 10); u++)
              ;
            if (h = e2.md.helpers.parseLinkTitle(e2.src, u, e2.posMax), u < k && m !== u && h.ok)
              for (f = h.str, u = h.pos; u < k && (s = e2.src.charCodeAt(u), i(s) || s === 10); u++)
                ;
            else
              f = "";
        ...
        e.exports = function(e2, t2) {
          var r2, i, s, o = e2.pos;
          return !!e2.md.options.html && (s = e2.posMax, !(e2.src.charCodeAt(o) !== 60 || o + 2 >= s) && (!((r2 = e2.src.charCodeAt(o + 1)) !== 33 && r2 !== 63 && r2 !== 47 && !function(e3) {
            var t3 = 32 | e3;
            return t3 >= 97 && t3 <= 122;
          ...
          if (u + 1 < p) {
            if (e2.src.charCodeAt(u + 1) === 35) {
              if (l = e2.src.slice(u).match(a))
                return t2 || (r2 = l[1][0].toLowerCase() === "x" ? parseInt(l[1].slice(1), 16) : parseInt(l[1], 10), e2.pending += s(r2) ? o(r2) : o(65533)), e2.pos += l[0].length, true;
        ...
        e.exports = function(e2) {
          ...
          for (t2 = r2 = 0; t2 < s; t2++)
            i[t2].nesting < 0 && n--, i[t2].level = n, i[t2].nesting > 0 && n++, i[t2].type === "text" && t2 + 1 < s && i[t2 + 1].type === "text" ? i[t2 + 1].content = i[t2].content + i[t2 + 1].content : (t2 !== r2 && (i[r2] = i[t2]), r2++);
          t2 !== r2 && (i.length = r2);
        };
      }, function(e, t, r) {
        "use strict";
        ...
        function u(e2) {
          ...
          e2.__compiled__ = {}, Object.keys(e2.__schemas__).forEach(function(t3) {
            ...
            if (r2 !== null) {
              ...
              if (e2.__compiled__[t3] = n3, i(r2) === "[object Object]")
                return !function(e3) {
                  return i(e3) === "[object RegExp]";
        ...
        f.prototype.add = function(e2, t2) {
          ...
          return this.__opts__.fuzzyLink && this.__compiled__["http:"] && (c2 = e2.search(this.re.host_fuzzy_test)) >= 0 && (this.__index__ < 0 || c2 < this.__index__) && (r2 = e2.match(this.__opts__.fuzzyIP ? this.re.link_fuzzy : this.re.link_no_ip_fuzzy)) !== null && (s2 = r2.index + r2[1].length, (this.__index__ < 0 || s2 < this.__index__) && (this.__schema__ = "", this.__index__ = s2, this.__last_index__ = r2.index + r2[0].length)), this.__opts__.fuzzyEmail && this.__compiled__["mailto:"] && e2.indexOf("@") >= 0 && (n2 = e2.match(this.re.email_fuzzy)) !== null && (s2 = n2.index + n2[1].length, o2 = n2.index + n2[0].length, (this.__index__ < 0 || s2 < this.__index__ || s2 === this.__index__ && o2 > this.__last_index__) && (this.__schema__ = "mailto:", this.__index__ = s2, this.__last_index__ = o2)), this.__index__ >= 0;
          ...
          !function(s) {
            ...
            function x(e3) {
              ...
              for (i2 = r2 > 0 ? r2 + 1 : 0; i2 < m2; ) {
                ...
                v2 = y(_2 - s2, t2 = d2.length + 1, s2 == 0), f(_2 / t2) > c - b2 && g("overflow"), b2 += f(_2 / t2), _2 %= t2, d2.splice(_2++, 0, b2);
              }
              return k(d2);
            }
            function C(e3) {
        ...
        var n = r(17), i = r(2);
        function s(e2) {
          var t2 = e2 === void 0 ? {} : e2, r2 = t2.Prism, s2 = t2.baseConfig, o = t2.codeBlockClass, a = t2.codeHighlightExtensionMap, c = a === void 0 ? {} : a, l = Object(n.default)(s2);
        ...
        e.exports = function(e2, t2, r2) {
          var n = (r2 = r2 || {}).marker || ":", i = n.charCodeAt(0), s = n.length, o = r2.validate || function(e3) {
            ...
            return e3[r3].nesting === 1 && e3[r3].attrJoin("class", t2), s2.renderToken(e3, r3, n2, i2, s2);
          };
        ...
        function o(e2) {
          return typeof e2 == "string" ? function() {
            return e2;
          } : e2;
        }
        var a = function(e2, t2) {
          var r2 = t2.validate, n2 = t2.marker, i2 = t2.render, a2 = t2.type, c2 = t2.before, l = t2.after, u = t2.defaultTitle, p = u === void 0 ? a2.toUpperCase() : u, h = t2.blockClass, f = h === void 0 ? "custom-block" : h;
          if (a2) {
            var d, g;
            if (!i2)
              c2 !== void 0 && l !== void 0 ? (d = o(c2), g = o(l)) : (d = function(e3) {
                return '<div class="' + f + " " + a2 + '">' + (e3 ? '<p class="' + f + '-title">' + e3 + "</p>" : "") + "\n";
              }, g = function() {
                return "</div>\n";
              }), i2 = function(e3, t3) {
                var r3 = e3[t3], n3 = r3.info.trim().slice(a2.length).trim();
                return !n3 && p && (n3 = typeof p == "function" ? p() : p), r3.nesting === 1 ? d(n3) : g(n3);
              };
        ...
        r(80), r(84), r(85), t.default = { install: function(e2, t2) {
          var r2, i2, s2, o2, a2, l, u, p, h, f = (s2 = (i2 = r2 === void 0 ? {} : r2).name, o2 = s2 === void 0 ? "tip" : s2, a2 = i2.icon, l = a2 === void 0 ? "v-md-icon-tip" : a2, u = i2.text, p = function(e3, t3) {
            t3 === void 0 && (t3 = "tip"), e3.insert(function(r3) {
...
// dep:@kangc_v-md-editor_lib_theme_vuepress_js
var kangc_v_md_editor_lib_theme_vuepress_js_default = require_vuepress();
export {
  kangc_v_md_editor_lib_theme_vuepress_js_default as default
};
/*! https://mths.be/punycode v1.4.1 by @mathias */
//# sourceMappingURL=@kangc_v-md-editor_lib_theme_vuepress_js.js.map
